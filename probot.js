...
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/TeJQeuW**")
...
client.on('message', message => {
  if (message.author.bot) return;
   if (message.content === prefix + "!123123123123") {
...
client.on('message', message => { 
    ...
    .setFooter(`Silver`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message', message => {
    ...
    if(message.content.startsWith(prefix + '123123132')) {
      if(!message.channel.guild) return;
                    moment.locale('en');
...
if(message.content.startsWith(prefix + 'simba')) {
          if (!args[0]) {
...
if(message.content === prefix + '!123123123') {
